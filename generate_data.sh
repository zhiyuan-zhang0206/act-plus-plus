...
python record_sim_episodes_optimized.py --task_name openlid --dataset_dir generated_data --num_episodes 50 --render_interval 10 --render_start 200 --final_reward_threshold 2.8
