...
# python record_sim_episodes_optimized.py --task_name stir --dataset_dir generated_data --num_episodes 50 --render_interval 10 --render_start 200
...
python record_sim_episodes_optimized.py --task_name openlid --dataset_dir generated_data --num_episodes 50 --render_interval 10 --render_start 200
